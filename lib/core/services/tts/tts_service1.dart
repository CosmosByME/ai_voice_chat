...
class TtsService1 implements TtsService {
  final AudioService audioService;
  TtsService1({required this.audioService});
  ...
  Future<void> speak(String text) async {
    ...
    final audioData = await _synthesize(tokenIds);
    await audioService.playPcm(audioData);
  }
